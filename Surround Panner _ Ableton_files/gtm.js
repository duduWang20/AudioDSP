...
"resource": {
  ...
  "rules":[
    ...
    [["if",16,106],["add",55]],
    [["if",6,7],["add",56],["block",1,3,139,140]],
    [["if",107,108],["add",57]],
    [["if",8,108],["add",58]],
    ...
    [["if",6,116],["add",63]],
    [["if",6,117],["add",64]],
    [["if",6],["add",65,66,67,68,69,70,71,72,80,85,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,123,124,125,126,127,128,129,130,131,132,133,134,135,136,137]],
    [["if",6,118],["add",73]],
    [["if",6,119],["add",74]],
    [["if",6,26],["add",75]],
    [["if",6,120],["add",76,77]],
    ...
    [["if",6,31],["add",79]],
    [["if",6,122],["add",81]],
    [["if",6,123],["add",83,84,88]],
    [["if",6,124],["add",86]],
    [["if",6,85],["add",87]],
    [["if",6,125],["add",89]],
    [["if",6,126],["add",138]],
    [["if",6,127],["add",139,140]],
    [["if",6,8],["block",2]],
    [["if",6,128],["block",139,140]]]
},
...
ac);c(28,bc);c(29,dc);c(45,ec);c(30,fc);c(32,gc);c(33,gc);c(34,hc);c(35,hc);c(46,ic);c(36,jc);c(43,kc);c(37,lc);c(38,mc);c(39,nc);c(40,oc);c(41,pc);c(42,qc);c(58,rc);c(57,sc);c(60,tc);c(61,uc);c(56,vc);c(62,wc);c(59,xc)},Dc=function(){var a=Ac,b=Cc();rb(a.a,"require",b)},Ec=function(a,b){a.a.a.M=b};var ad;
...
function zf(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.w[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Ed={},Bf=null,Cf=Math.random();Ed.B="GTM-2HCS";Ed.Nb="432";var Df={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Ef="www.googletagmanager.com/gtm.js";var Ff=Ef,Gf=null,Hf=null,If=null,Jf="//www.googletagmanager.com/a?id="+Ed.B+"&cv=116",Kf={},Lf={},Mf=function(){var a=Bf.sequence||0;Bf.sequence=a+1;return a};var Nf={},Of=function(a,b){Nf[a]=Nf[a]||[];Nf[a][b]=!0},Pf=function(a){for(var b=[],c=Nf[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
case "event":Bl(this,c.a[1],c.a[0],c)}this.a.shift()}};var Cl=function(a,b){return!0};var Dl=function(a,b){var c;return c};var El=function(a){};var Fl=function(a){var b;return jb(b,this.i)};var Gl=function(a,b){var c=null;return jb(c,this.i)};var Hl=function(a){var b;return jb(b,
...
Fe);a.add("makeTableMap",Ge);a.add("Math",re());a.add("mock",Ie);a.add("queryPermission",Wl);a.add("readCharacterSet",em);a.add("readTitle",fm);a.add("sendPixel",b);a.add("setCookie",Yl);a.add("setInWindow",Zl);a.add("sha256",am);a.add("TestHelper",Ke());a.add("getContainerVersion",Ae);a.add("toBase64",bm,!("btoa"in D)),a.add("fromBase64",
...
var Qn=function(a,b,c){function d(){var g=a();f+=e?(Qa()-e)*g.playbackRate/1E3:0;e=Qa()}var e=0,f=0;return{Vb:function(g,k,l){var m=a(),n=m.te,r=void 0!==l?Math.round(l):void 0!==k?Math.round(m.te*k):Math.round(m.qg),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),p=I.hidden?!1:.5<=In(c);d();var u=kn(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=g;u["gtm.videoUrl"]=m.url;u["gtm.videoTitle"]=m.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=p;Zm(u)},yh:function(){e=Qa()},Oc:function(){d()}}};var Rn=D.clearTimeout,Sn=D.setTimeout,S=function(a,b,c){if(Ag()){b&&J(b)}else return Pe(a,b,c)},Tn=function(){return D.location.href},Un=function(a){return Fh(Hh(a),"fragment")},Vn=function(a){return Gh(Hh(a))},Wn=function(a,b){return qg(a,b||2)},Xn=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Zm(a)):d=Zm(a);return d},Yn=function(a,b){D[a]=b},U=function(a,b,c){b&&(void 0===D[a]||c&&!D[a])&&(D[a]=
...
d.vtp_trackType){var Y={hitType:"social",socialNetwork:String(d.vtp_socialNetwork),socialAction:String(d.vtp_socialAction),socialTarget:String(d.vtp_socialActionTarget)};z(K,Y,!1);y("send",Y);}else if("TRACK_TRANSACTION"==d.vtp_trackType){}else if("TRACK_TIMING"==d.vtp_trackType){}else if("DECORATE_LINK"==d.vtp_trackType){}else if("DECORATE_FORM"==d.vtp_trackType){}else if("TRACK_DATA"==d.vtp_trackType){}else{d.vtp_enableEcommerce&&(y("require","ec","ec.js"),B());if(d.vtp_doubleClick||"DISPLAY_FEATURES"==d.vtp_advertisingFeaturesType){var wa="_dc_gtm_"+String(d.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require",
...
y){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(y)return w.setAttribute("src",c(x)),!0}return!1}function e(w,y){if(!w.getAttribute("data-gtm-yt-inspected-"+y.ud)&&(w.setAttribute("data-gtm-yt-inspected-"+y.ud,"true"),d(w,y.ze))){w.id||(w.id=a());var x=U("YT"),A=x.get(w.id);A||(A=new x.Player(w.id));var B=g(A,y),z={},E;for(E in B)z.$a=E,B.hasOwnProperty(z.$a)&&A.addEventListener(z.$a,function(H){return function(K){return B[H.$a](K.data)}}(z)),z={$a:z.$a}}}
function f(w){J(function(){function y(){for(var A=x.getElementsByTagName("iframe"),B=A.length,z=0;z<B;z++)e(A[z],w)}var x=U("document");y();wn(y)})}function g(w,y){var x,A;function B(){X=Qn(function(){return{url:Q,title:W,te:N,qg:w.getCurrentTime(),playbackRate:wa}},y.ud,w.getIframe());N=0;W=Q="";wa=1;return z}function z(P){switch(P){case p.PLAYING:N=Math.round(w.getDuration());Q=w.getVideoUrl();if(w.getVideoData){var M=w.getVideoData();W=M?M.title:""}wa=w.getPlaybackRate();y.jg?X.Vb("start"):X.Oc();
L=m(y.oh,y.nh,w.getDuration());return E(P);default:return z}}function E(){na=w.getCurrentTime();Ba=(new Date).getTime();X.yh();sa();return H}function H(P){var M;switch(P){case p.ENDED:return T(P);case p.PAUSED:M="pause";case p.BUFFERING:var Aa=w.getCurrentTime()-na;M=1<Math.abs(((new Date).getTime()-Ba)/1E3*wa-Aa)?"seek":M||"buffering";w.getCurrentTime()&&(y.ig?X.Vb(M):X.Oc());la();return K;case p.UNSTARTED:return B(P);default:return H}}function K(P){switch(P){case p.ENDED:return T(P);case p.PLAYING:return E(P);
case p.UNSTARTED:return B(P);default:return K}}function T(){for(;A;){var P=x;Rn(A);P()}y.hg&&X.Vb("complete",1);return B(p.UNSTARTED)}function Y(){}function la(){A&&(Rn(A),A=0,x=Y)}function sa(){if(L.length&&0!==wa){var P=-1,M;do{M=L[0];if(M.Ga>w.getDuration())return;P=(M.Ga-w.getCurrentTime())/wa;if(0>P&&(L.shift(),0===L.length))return}while(0>P);x=function(){A=0;x=Y;0<L.length&&L[0].Ga===M.Ga&&(L.shift(),X.Vb("progress",M.Re,M.Ve));sa()};A=Sn(x,1E3*P)}}var X,L=[],N,Q,W,wa,na,Ba,ob=B(p.UNSTARTED);
A=0;x=Y;return{onStateChange:function(P){ob=ob(P)},onPlaybackRateChange:function(P){na=w.getCurrentTime();Ba=(new Date).getTime();X.Oc();wa=P;la();sa()}}}function k(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||100<z||0>z||A.push(z/100)}A.sort(function(E,H){return E-H});return A}function l(w){for(var y=w.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||0>z||A.push(z)}A.sort(function(E,H){return E-H});return A}function m(w,y,x){var A=
w.map(function(E){return{Ga:E,Ve:E,Re:void 0}});if(!y.length)return A;var B=y.map(function(E){return{Ga:E*x,Ve:void 0,Re:E}});if(!A.length)return B;var z=A.concat(B);z.sort(function(E,H){return E.Ga-H.Ga});return z}function n(w){w.vtp_triggerStartOption?r(w):eh(function(){r(w)})}function r(w){var y=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,A=!!w.vtp_capturePause,B=k(w.vtp_progressThresholdsPercent+""),z=l(w.vtp_progressThresholdsTimeInSeconds+""),E=!!w.vtp_fixMissingApi;if(y||x||A||B.length||
z.length){var H={jg:y,hg:x,ig:A,nh:B,oh:z,ze:E,ud:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},K=U("YT"),T=function(){f(H)};J(w.vtp_gtmOnSuccess);if(K)K.ready&&K.ready(T);else{var Y=U("onYouTubeIframeAPIReady");Yn("onYouTubeIframeAPIReady",function(){Y&&Y();T()});J(function(){for(var la=U("document"),sa=la.getElementsByTagName("script"),X=sa.length,L=0;L<X;L++){var N=sa[L].getAttribute("src");if(b(N,"iframe_api")||b(N,"player_api"))return}for(var Q=la.getElementsByTagName("iframe"),W=
Q.length,wa=0;wa<W;wa++)if(!v&&d(Q[wa],H.ze)){S("https://www.youtube.com/iframe_api");v=!0;break}})}}else J(w.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],p={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},u,v=!1;Z.__ytl=n;Z.__ytl.g="ytl";Z.__ytl.h=!0;Z.__ytl.priorityOverride=0}();
...
Z.b.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Tn()}function b(f,g){Te(f,"hashchange",function(k){var l=a(k);g({source:"hashchange",state:null,url:Vn(l),P:Un(l)})})}function c(f,g){Te(f,"popstate",function(k){var l=a(k);g({source:"popstate",state:k.state,url:Vn(l),P:Un(l)})})}function d(f,g,k){var l=g.history,m=l[f];if(Ca(m))try{l[f]=function(n,r,t){m.apply(l,[].slice.call(arguments,0));k({source:f,state:n,url:Vn(Tn()),
P:Un(Tn())})}}catch(n){}}function e(){var f={source:null,state:U("history").state||null,url:Vn(Tn()),P:Un(Tn())};return function(g){var k=f,l={};l[k.source]=!0;l[g.source]=!0;if(!l.popstate||!l.hashchange||k.P!=g.P){var m={event:"gtm.historyChange","gtm.historyChangeSource":g.source,"gtm.oldUrlFragment":f.P,"gtm.newUrlFragment":g.P,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":g.state};m["gtm.oldUrl"]=f.url,m["gtm.newUrl"]=g.url;
f=g;Xn(m)}}}(function(f){Z.__hl=f;Z.__hl.g="hl";Z.__hl.h=!0;Z.__hl.priorityOverride=0})(function(f){var g=U("self");if(!ao("hl")){var k=e();b(g,k);c(g,k);d("pushState",g,k);d("replaceState",g,k);bo("hl")}J(f.vtp_gtmOnSuccess)})}();
